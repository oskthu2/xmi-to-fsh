# CV CWE - Logical Models from Visual Paradigm XMI v0.1.0

## Logical Model: CV CWE 

 
Supporting logical model generated from gloo4.xmi (source class: CV CWE). 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/xmi.to.fsh|current/StructureDefinition/StructureDefinition-CV-CWE.json)
...
```json
{
  ...
  "url" : "http://example.org/fhir/xmi-to-fsh/StructureDefinition/CV-CWE",
  "version" : "0.1.0",
  "name" : "CVCWE",
  "title" : "CV CWE",
  "status" : "draft",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/xmi-to-fsh/StructureDefinition/CV-CWE",
  ...
  "differential" : {
    "element" : [{
      ...
      "path" : "CV-CWE",
      "short" : "CV CWE",
      "definition" : "Supporting logical model generated from gloo4.xmi (source class: CV CWE)."
    }]
  }
}
