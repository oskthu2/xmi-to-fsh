# Urval fynd bakterieegenskaper laboratoriemedicin - Logical Models from Visual Paradigm XMI v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/xmi.to.fsh|current/StructureDefinition/StructureDefinition-Urval-fynd-bakterieegenskaper-laboratoriemedicin.json)
...
Other representations of profile: [CSV](../StructureDefinition-Urval-fynd-bakterieegenskaper-laboratoriemedicin.csv), [Excel](../StructureDefinition-Urval-fynd-bakterieegenskaper-laboratoriemedicin.xlsx) 
...
```json
{
  ...
  "url" : "http://example.org/fhir/xmi-to-fsh/StructureDefinition/Urval-fynd-bakterieegenskaper-laboratoriemedicin",
  "version" : "0.1.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/xmi-to-fsh/StructureDefinition/Urval-fynd-bakterieegenskaper-laboratoriemedicin",
