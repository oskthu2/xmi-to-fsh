# ST - Logical Models from Visual Paradigm XMI v0.1.0

## Logical Model: ST 

 
Supporting logical model generated from gloo4.xmi (source class: ST). 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/xmi.to.fsh|current/StructureDefinition/StructureDefinition-ST.json)
...
```json
{
  ...
  "url" : "http://example.org/fhir/xmi-to-fsh/StructureDefinition/ST",
  "version" : "0.1.0",
  "name" : "ST",
  "title" : "ST",
  "status" : "draft",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/xmi-to-fsh/StructureDefinition/ST",
  ...
  "differential" : {
    "element" : [{
      ...
      "path" : "ST",
      "short" : "ST",
      "definition" : "Supporting logical model generated from gloo4.xmi (source class: ST)."
    }]
  }
}
