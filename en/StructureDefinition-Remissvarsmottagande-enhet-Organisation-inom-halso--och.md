# Remissvarsmottagande enhet : Organisation (inom hälso- och sjukvård) - Logical Models from Visual Paradigm XMI v0.1.0

## Logical Model: Remissvarsmottagande enhet : Organisation (inom hälso- och sjukvård) 

 
Supporting logical model generated from gloo4.xmi (source class: Remissvarsmottagande enhet : Organisation (inom hälso- och sjukvård)). 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/xmi.to.fsh|current/StructureDefinition/StructureDefinition-Remissvarsmottagande-enhet-Organisation-inom-halso--och.json)
...
```json
{
  ...
  "url" : "http://example.org/fhir/xmi-to-fsh/StructureDefinition/Remissvarsmottagande-enhet-Organisation-inom-halso--och",
  "version" : "0.1.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/xmi-to-fsh/StructureDefinition/Remissvarsmottagande-enhet-Organisation-inom-halso--och",
  ...
  "differential" : {
    "element" : [{
      ...
      "definition" : "Supporting logical model generated from gloo4.xmi (source class: Remissvarsmottagande enhet : Organisation (inom hälso- och sjukvård))."
    },
    {
