# TS - Logical Models from Visual Paradigm XMI v0.1.0

## Logical Model: TS 

 
Supporting logical model generated from gloo4.xmi (source class: TS). 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/xmi.to.fsh|current/StructureDefinition/StructureDefinition-TS.json)
...
```json
{
  ...
  "url" : "http://example.org/fhir/xmi-to-fsh/StructureDefinition/TS",
  "version" : "0.1.0",
  "name" : "TS",
  "title" : "TS",
  "status" : "draft",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/xmi-to-fsh/StructureDefinition/TS",
  ...
  "differential" : {
    "element" : [{
      ...
      "path" : "TS",
      "short" : "TS",
      "definition" : "Supporting logical model generated from gloo4.xmi (source class: TS)."
    }]
  }
}
