...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/test1|current/StructureDefinition/StructureDefinition-Patient.json)
...
```json
{
  ...
  "url" : "http://example.org/fhir/test1/StructureDefinition/Patient",
  "version" : "0.1.0",
  "name" : "Patient",
  "title" : "Patient",
  "status" : "draft",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/test1/StructureDefinition/Patient",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "max" : "*",
      "type" : [{
        "code" : "http://example.org/fhir/test1/StructureDefinition/Personal"
      }]
    }]
  }
}
