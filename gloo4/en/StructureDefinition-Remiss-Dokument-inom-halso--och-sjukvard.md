# Remiss : Dokument (inom hälso- och sjukvård) - gloo4 v0.1.0
...
```json
{
  ...
  "url" : "http://example.org/fhir/gloo4/StructureDefinition/Remiss-Dokument-inom-halso--och-sjukvard",
  "version" : "0.1.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/gloo4/StructureDefinition/Remiss-Dokument-inom-halso--och-sjukvard",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "max" : "1",
      "type" : [{
        "code" : "http://example.org/fhir/gloo4/StructureDefinition/Remissmottagande-enhet-Organisation-inom-halso--och-sju"
      }]
    },
    {
      ...
      "max" : "1",
      "type" : [{
        "code" : "http://example.org/fhir/gloo4/StructureDefinition/Patient"
      }]
    },
    {
