...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/gloo4|current/StructureDefinition/StructureDefinition-Referensvarde.json)
...
```json
{
  ...
  "url" : "http://example.org/fhir/gloo4/StructureDefinition/Referensvarde",
  "version" : "0.1.0",
  "name" : "Referensvarde",
  "title" : "Referensvärde",
  "status" : "draft",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/gloo4/StructureDefinition/Referensvarde",
