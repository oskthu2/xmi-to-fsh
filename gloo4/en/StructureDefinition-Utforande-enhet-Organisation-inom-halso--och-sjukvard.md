# Utförande enhet : Organisation (inom hälso- och sjukvård) - gloo4 v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/gloo4|current/StructureDefinition/StructureDefinition-Utforande-enhet-Organisation-inom-halso--och-sjukvard.json)
...
```json
{
  ...
  "url" : "http://example.org/fhir/gloo4/StructureDefinition/Utforande-enhet-Organisation-inom-halso--och-sjukvard",
  "version" : "0.1.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/gloo4/StructureDefinition/Utforande-enhet-Organisation-inom-halso--och-sjukvard",
