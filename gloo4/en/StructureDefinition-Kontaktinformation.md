# Kontaktinformation - gloo4 v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/gloo4|current/StructureDefinition/StructureDefinition-Kontaktinformation.json)
...
```json
{
  ...
  "url" : "http://example.org/fhir/gloo4/StructureDefinition/Kontaktinformation",
  "version" : "0.1.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/gloo4/StructureDefinition/Kontaktinformation",
