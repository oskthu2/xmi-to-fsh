# Laboratoriesvar : Dokument (inom hälso- och sjukvård) - gloo4 v0.1.0

## Logical Model: Laboratoriesvar : Dokument (inom hälso- och sjukvård) 

 
Remissvar som avser laboratorieanalysresultat. 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/gloo4|current/StructureDefinition/StructureDefinition-Laboratoriesvar-Dokument-inom-halso--och-sjukvard.json)
...
```json
{
  ...
  "url" : "http://example.org/fhir/gloo4/StructureDefinition/Laboratoriesvar-Dokument-inom-halso--och-sjukvard",
  "version" : "0.1.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/gloo4/StructureDefinition/Laboratoriesvar-Dokument-inom-halso--och-sjukvard",
  ...
  "differential" : {
    "element" : [{
      ...
      "definition" : "Remissvar som avser laboratorieanalysresultat."
    },
    {
