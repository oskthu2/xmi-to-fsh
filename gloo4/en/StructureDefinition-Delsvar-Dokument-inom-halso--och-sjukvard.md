# Delsvar : Dokument (inom hälso- och sjukvård) - gloo4 v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/gloo4|current/StructureDefinition/StructureDefinition-Delsvar-Dokument-inom-halso--och-sjukvard.json)
...
```json
{
  ...
  "url" : "http://example.org/fhir/gloo4/StructureDefinition/Delsvar-Dokument-inom-halso--och-sjukvard",
  "version" : "0.1.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/gloo4/StructureDefinition/Delsvar-Dokument-inom-halso--och-sjukvard",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "max" : "1",
      "type" : [{
        "code" : "http://example.org/fhir/gloo4/StructureDefinition/Preliminarsvar-Dokument-inom-halso--och-sjukvard"
      }]
    },
    {
