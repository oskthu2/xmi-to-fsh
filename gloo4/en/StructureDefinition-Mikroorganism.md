...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/gloo4|current/StructureDefinition/StructureDefinition-Mikroorganism.json)
...
```json
{
  ...
  "url" : "http://example.org/fhir/gloo4/StructureDefinition/Mikroorganism",
  "version" : "0.1.0",
  "name" : "Mikroorganism",
  "title" : "Mikroorganism",
  "status" : "draft",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/fhir/gloo4/StructureDefinition/Mikroorganism",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "max" : "1",
      "type" : [{
        "code" : "http://example.org/fhir/gloo4/StructureDefinition/Resistensbestamning-Aktivitet-inom-halso--och-sjukvard"
      }]
    },
    {
